    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p><b>Result:</b> {projects["warframe-offer-highlight"].result}</p>
            </div>
            ...
            <div className="project">
                ...
                <p><b>Result:</b> {projects["warframe-progression-guidance"].result}</p>
            </div>
            ...
            <div className="project">
                ...
                <p><b>Result:</b> {projects["unreal-performance-testing"].result}</p>
            </div>
            ...
            <div className="project">
                ...
                <p><b>Result:</b> {projects["unity-localization"].result}</p>
            </div>
            ...
            <div className="project">
                ...
                <p><b>Result:</b> {projects["unity-tagging-query"].result}</p>
            </div>
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p><b>Result:</b> {projects["asset-tools"].result}</p>
            </div>
        </div>
